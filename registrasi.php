                            ...
                            <div class="col-md-9 col-lg-8 mx-auto">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="d-grid mt-3">
                                        <button class="btn btn-lg btn-info text-white btn-login text-uppercase fw-bold mb-2" name="kirim" type="submit">Sign in</button>
                                    </div>
                                </form>
                                <hr>
                                <p>Sudah punya akun? <a href="login.php">Log In disini</a></p>
                            </div>
                        </div>
                    </div>
                </div>
