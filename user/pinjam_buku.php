...
$qcekpeminjaman = mysqli_query($koneksi," SELECT COUNT(*) AS total_buku_dipinjam FROM peminjaman WHERE UserID = '$userID'");
$dpinjam = mysqli_fetch_assoc($qcekpeminjaman);

if($dpinjam['total_buku_dipinjam'] > 5){
    ?>
    <div class="mt-5">
        <div class="container mt-5" style="padding-top: 250px">
            <h2>Tidak bisa meminjam, anda meminjam lebih dari 5 buku</h2>
        </div>
    </div>
    <?php
}else{
